...
class AddStaff extends Component {
  ...
  submitHandler = (e: { preventDefault: () => void }) => {
    ...
    axios
      .post("..................................", this.state)
      .then((resp: any) =>
        console.log(resp, "Issued books data added successfully")
      )
      .catch((error) => {
        console.log(error, "error in posting data of Issued books ");
      });
  };
